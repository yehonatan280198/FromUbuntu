...
class Verify:
    ...
    def __init__(self, delaysProb, safe_prob, verifyAlpha, process_queue, findConflictALg, obstacles_agents):
        ...
        for sim in range(s0):
            ...
            while active_agents:
                ...
                for agent, info_path in paths_copy.items():
                    if self.obstacles_agents and agent in N.inactiveAgents:
                        continue
